...
public class MicrophoneListener : MonoBehaviour {
    ...
    public void Init()
    {
        ...
        if (Debugging)
        {
            Debug.Log("Microphone listener initialized.");
        }
    ...
    void Update () 
    {
        ...
        if(Input.GetButtonUp("Mute"))
        {
            ...
            if (Debugging)
            {
                Debug.Log("Microphone enabled: " + MicrophoneEnabled);
            }
        }
        ...
        if(MicrophoneEnabled)
        {
            ...
            if(Kissing)
            {
                if (Debugging)
                {
                    Debug.Log("Kissing with microphone..");
                }
    ...
    private void AnalyzeSound()
    {
        if (audio == null)
        {
            if (Debugging)
            {
                Debug.Log("Can't analyze sound.. audio is null!");
            }
            return;
        }
